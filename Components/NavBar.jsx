          ...
          focus:shadow-outline"
            ...
            {isMenuOpen && (
              <div className="absolute top-0 left-0 w-full">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      >
                        ...
                        <span className="ml-2 yexy-xl font-bold tracking-wide text-gray-800
                      uppercase">
                          Company
                        </span>
                      </a>
                ...
                hover:bg-slate-200 focus:bg-slate-200 focus:outline-none
                focus:shadow-outline"
            ...
            <nav>
              <ul className="space-y-4">
                ...
                <li>
                  ...
                  w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 
