...
const PopUp = ({setOpenModel, donate, donateFunction, getDonations}) => {
  ...
  useEffect(()=>{
    ...
    return async()=>{
      ...
      setAllDonationData(JSON.stringify(donationData))
      ...
      <div className="relative w-auto my-6 mx-auto max-w-3xl">
        ...
        bg-white outline-none focus:outline-none">
          ...
          <div className="relative p-6 flex-auto">
            ...
            shadow-sm appearance-none focus:outline-none focus:shadow-outline"
          ...
          <div className="flex items-center justify-end p-6 boredr-tborder-solid
          border-slate-200 rounded-b">
            ...
            <button className="background text-white active:bg-emerald-600
            font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none
            focus:outline-none mr-1 mb-1 ease-linear translate-all duration-150"
            type="button"
